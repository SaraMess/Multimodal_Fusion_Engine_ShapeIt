...
public class Wassup extends PApplet {
...
public enum FSM {
  WAIT_MSG, // waiting for messages
  SEND_FEEDBACK, // send text to ppilot
  NO_RECO, // speech rejection event
   
}


  public void settings() { size(1020, 1010); }

  static public void main(String[] passedArgs) {
    String[] appletArgs = new String[] { "Wassup" };
    if (passedArgs != null) {
